    ...
    <View className="flex-1 bg-white dark:bg-neutral-950 items-center justify-center px-6">
      ...
      {status === 'success' && (
        <>
          ...
          <View className="items-center">
            <Text className="text-xl font-bold text-neutral-900 dark:text-white mb-1">Email Verified</Text>
      ...
      {status === 'error' && (
        <>
          ...
          <View className="items-center">
            <Text className="text-xl font-bold text-neutral-900 dark:text-white mb-1">Verification Failed</Text>
            <Text className="text-sm text-neutral-500 dark:text-neutral-400 text-center mb-6 max-w-xs">{message}</Text>
          </View>
          <Pressable
            onPress={() => navigation.navigate('Main' as never)}
            className="border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 px-8 py-3.5 rounded-xl w-full items-center"
          >
            <Text className="text-neutral-900 dark:text-white font-bold text-sm">Back to App</Text>
          </Pressable>
        </>
      )}
    </View>
